...
/**
 * Tests {@link UtilMessages}.
 *
 * @since SINCE
 */
public class UtilMessagesTest extends MessagesTestCase {

  public UtilMessagesTest() {
    super(UtilMessages.class);
  }

  @Test
  public void messagesProvidesMessageInstance() throws Exception {
    assertThat(messages(), Matchers.instanceOf(UtilMessages.class));
  }
