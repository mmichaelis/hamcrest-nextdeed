 ...
 * @since SINCE
 */
public class BaseMessagesTest extends MessagesTestCase {

  public BaseMessagesTest() {
    super(BaseMessages.class);
  }

  @Test
  public void messagesProvidesMessageInstance() throws Exception {
    assertThat(messages(), Matchers.instanceOf(BaseMessages.class));
  }
