...
/**
 * Tests {@link ReflectMessages}.
 * @since SINCE
 */
public class ReflectMessagesTest extends MessagesTestCase {

  public ReflectMessagesTest() {
    super(ReflectMessages.class);
  }

  @Test
  public void messagesProvidesMessageInstance() throws Exception {
    assertThat(messages(), Matchers.instanceOf(ReflectMessages.class));
  }
